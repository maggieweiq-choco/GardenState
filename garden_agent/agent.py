...
root_agent = Agent(
    ...
    instruction=(
        ...
        "'tasks' collection of the 'garden' database. Always perform this "
        "plant/sensor/task CRUD with the MongoDB tools (never invent your own "
        "storage), and read the records back so the writes are confirmed.\n"
